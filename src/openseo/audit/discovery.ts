// Ported from OpenSEO src/server/lib/audit/discovery.ts at commit
// 0ffff93101043aad7600a3b6a499a0cd2887ef49.
// Copyright (c) 2026 Ben Senescu. MIT License; see LICENSES/OpenSEO.txt.
// Local changes: the crawler identifies itself as AgenticSEO-Audit; a type-only
// cast for robots-parser's CommonJS default export.
/**
 * robots.txt and sitemap.xml discovery for the site audit crawler.
 */
import robotsParserModule from "robots-parser";
import { XMLParser } from "fast-xml-parser";
import { isSameOrigin, normalizeUrl } from "./url-utils.js";

// robots-parser is CommonJS with an ESM-style declaration file: at runtime the
// default import is the parser function itself, which the types model as .default.
