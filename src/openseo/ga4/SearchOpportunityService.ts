// Ported from OpenSEO src/server/features/ga4/services/SearchOpportunityService.ts at commit
// 0ffff93101043aad7600a3b6a499a0cd2887ef49.
// Copyright (c) 2026 Ben Senescu. MIT License; see LICENSES/OpenSEO.txt.
// Local change: GscNotConnectedError takes no project id (see gsc/gscErrors.ts).
import { GscService } from "./projectConnections.js";
import { GscNotConnectedError } from "../gsc/gscErrors.js";
import {
  Ga4ReportingService,
  resolveGa4DateRange,
} from "./Ga4ReportingService.js";
import { Ga4ReportError } from "./ga4Errors.js";
import { Ga4ConnectionRepository } from "./projectConnections.js";
import { ga4DateInTimeZone, shiftGa4Date } from "./Ga4Dates.js";
...
async function getOpportunities(
  ...
  if (!gscConnection) throw new GscNotConnectedError();
