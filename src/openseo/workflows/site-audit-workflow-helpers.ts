// Ported from OpenSEO src/server/workflows/site-audit-workflow-helpers.ts at commit
// 0ffff93101043aad7600a3b6a499a0cd2887ef49.
// Copyright (c) 2026 Ben Senescu. MIT License; see LICENSES/OpenSEO.txt.
// Local change: the crawler identifies itself as AgenticSEO-Audit.
import type { CrawledPageResult } from "../audit/types.js";
import type { PageFetchClass } from "../shared/audit-fetch-class.js";
import { sha256Hex } from "../audit/ids.js";
import { normalizeUrl } from "../audit/url-utils.js";
import type { CrawlThrottle } from "../audit/crawl-throttle.js";

const CRAWL_USER_AGENT = "AgenticSEO-Audit/1.0";
...
export async function crawlPage(
  ...
  try {
    ...
    const { analyzeHtml } = await import("../audit/page-analyzer.js");
