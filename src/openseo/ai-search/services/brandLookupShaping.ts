// Ported from OpenSEO src/server/features/ai-search/services/brandLookupShaping.ts at commit
...
import type {
  ...
  LlmMentionItem,
  LlmTopPagesItem,
} from "../../dataforseoLlmSchemas.js";
import { safeHostname, safeHttpUrl } from "../safeUrl.js";
import { deriveCitedSources } from "./citedSources.js";
import {
  computeShareOfVoice,
  roundOrNull,
  sumNullable,
...
import type { BrandLookupResult } from "../../schemas/ai-search.js";
import type { detectTarget } from "../../shared/targetDetection.js";
import {
