// Ported from OpenSEO src/server/features/ai-search/services/citedSources.ts at commit
// 0ffff93101043aad7600a3b6a499a0cd2887ef49.
// Copyright (c) 2026 Ben Senescu. MIT License; see LICENSES/OpenSEO.txt.
import { sortBy } from "remeda";
import type { LlmPlatform } from "../../dataforseo/shared.js";
import type {
  LlmMentionItem,
  LlmTopPagesItem,
} from "../../dataforseoLlmSchemas.js";
import { safeHostname, safeHttpUrl } from "../safeUrl.js";
import { roundOrNull } from "./shareOfVoice.js";
