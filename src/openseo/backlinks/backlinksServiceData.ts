// Ported from OpenSEO src/server/features/backlinks/services/backlinksServiceData.ts at commit
// 0ffff93101043aad7600a3b6a499a0cd2887ef49.
// Copyright (c) 2026 Ben Senescu. MIT License; see LICENSES/OpenSEO.txt.
// Local changes: the local DataforseoClient replaces the billing customer (callers
// pass it in), the credit-attribution parameter is removed, and a failed cache write
// fails the command instead of being logged, as in the other ported services.
import { z } from "zod";
import type { DataforseoClient } from "../dataforseo/client.js";
import type {
  BacklinksHistoryItem,
  BacklinksSummaryItem,
} from "../dataforseo/backlinks.js";
...
} from "./backlinksOverviewSchema.js";
import {
...
} from "./backlinksApiFilters.js";
import {
  buildBacklinksScopeFilter,
  countExpressionConditions,
  prependScopeClauses,
} from "../dataforseo/researchScopeFilters.js";
import { buildSubfolderOverview } from "./backlinksSubfolderOverview.js";
import {
  buildPageResult,
  mapBacklinksRows,
